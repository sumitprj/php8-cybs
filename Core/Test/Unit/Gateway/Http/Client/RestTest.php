...
class RestTest extends TestCase
{
    ...
    /**
     * @var \PHPUnit_Framework_MockObject_MockObject|\Zend_Http_Response
     */
    ...
    protected function setUp()
    {
        ...
        $this->httpClientFactoryMock = $this->createMock(\Magento\Framework\HTTP\ZendClientFactory::class);
