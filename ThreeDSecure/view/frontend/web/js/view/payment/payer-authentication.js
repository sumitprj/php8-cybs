define([
    ...
    return {
        ...
        placeOrder: function (methodComponent, originalAction, cardNumber, cardType) {
            ...
            require(['CyberSource_ThreeDSecure/js/view/payment/cardinal'], function (Cardinal) {
                Cardinal.setup(methodComponent.messageContainer, methodComponent.getData(), cardNumber)
                    .done(
                        function (sessionId) {
