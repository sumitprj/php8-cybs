...
use CyberSource\VisaCheckout\Gateway\Request\AuthorizationRequest;
 ...
 */
class AuthorizationRequestTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new AuthorizationRequest($this->configMock, $this->requestDataBuilderMock, $this->subjectReaderMock);
    }
    ...
    public function testBuild()
    {
        ...
        $this->requestDataBuilderMock->expects(static::once())
            ->method('buildAuthorizationRequestData')
