...
use CyberSource\VisaCheckout\Gateway\Request\SettlementRequest;
 ...
 */
class SettlementRequestTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->request = new SettlementRequest($this->configMock, $this->requestDataBuilderMock, $this->subjectReaderMock);
    }
    ...
    public function testBuild()
    {
        ...
        $this->requestDataBuilderMock->expects(static::once())
            ->method('buildSettlementRequestData')
