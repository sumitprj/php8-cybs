...
use CyberSource\VisaCheckout\Gateway\Request\RefundRequest;
...
class RefundRequestTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new RefundRequest($this->configMock, $this->requestDataBuilderMock, $this->subjectReaderMock);
    }
    ...
    public function testBuild()
    {
        ...
        $this->requestDataBuilderMock->expects(static::once())
            ->method('buildRefundRequestData')
            ->with($this->paymentMock, $buildSubject['amount'])
