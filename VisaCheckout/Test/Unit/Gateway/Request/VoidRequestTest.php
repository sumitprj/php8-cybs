...
use CyberSource\VisaCheckout\Gateway\Request\VoidRequest;
...
class VoidRequestTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new VoidRequest($this->configMock, $this->requestDataBuilderMock, $this->subjectReaderMock);
    }
    ...
    public function testBuild()
    {
        ...
        $this->requestDataBuilderMock->expects(static::once())
            ->method('buildAuthorizeReversalRequestData')
