                ...
                setBillingAddress().then(this.updateSession()).then(function () {
                    Klarna.Credit.authorize(
                        ...
                        function (response) {
                            ...
                            $(form).append('<input name="agreementId" value="' + $("#cybersourceklarna").parent().parent().children('.payment-method-content').children(".checkout-agreements-block").children().children().children().children().val() + '"/>');
                            $("body").append(form);
                            $(form).submit();
